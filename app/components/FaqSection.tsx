const faqs = [
  {
    ...
    answer: (
      <>
        <p className="mb-0">온라인 강의 사이트 제작부터 수강생 관리, 결제, 보안, 알림톡 자동화까지 한 번에 제공하는 교육 플랫폼입니다.</p>
        <p className="mt-[21px] mb-0">복잡한 개발 없이 브랜드 전용 인터넷 강의 플랫폼을 구축하고 운영할 수 있도록 돕습니다.</p>
